...
public class FreedomChat implements ModInitializer {
    ...
    public void onInitialize() {
        ServerLifecycleEvents.SERVER_STARTED.register(server -> {
            this.server = server;
            if (!Boolean.getBoolean("im.evan.freedomchat.bypassprotocolcheck") && SharedConstants.getProtocolVersion() != 777) {
                logger.warn("This version of FreedomChat only supports protocol version 777 (26.3). Please use the appropriate version of FreedomChat for your server");

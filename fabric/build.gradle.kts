...
dependencies {
    ...
    modImplementation(group = "net.fabricmc", name = "fabric-loader", version = "0.16.11")
    modImplementation(group = "net.fabricmc.fabric-api", name = "fabric-api", version = "0.119.2+1.21.4")

...
dependencies {
    minecraft(group = "com.mojang", name = "minecraft", version = "26.3")
    implementation(group = "net.fabricmc", name = "fabric-loader", version = "0.19.5")
    implementation(group = "net.fabricmc.fabric-api", name = "fabric-api", version = "0.160.5+26.3")
